    ...
    <div id="main_content" class="container-fluid justify-content-between p-0">
        ...
        <div id="formlogin" class="container d-flex flex-column justify-content-center">
            ...
            <div class="row d-flex justify-content-sm-center mt-5 mb-n1 px-4">
                <h2 class="headline mx-auto mb-5 mt-5">Daftar Disini Yuk!</h2>
            </div>
            <!--Headline-end-->
            ...
            <div class="container d-flex justify-content-center align-content-center mb-n5">
                <form action="../config/action-register.php" method="POST">
                    ...
                    <p class="mx-auto text-center my-4 font-weight-normal">Dengan mendaftar, anda setuju dengan aturan pelayanan dan penggunaan kami </p>

                    <!--button-->
                    <div class="row">
                    <button type="submit" id="button-action" class="btn mx-auto px-4"><h5>Daftar</h5></button>
                    </div>
                    <!--button-end-->
                </form>
            </div>
